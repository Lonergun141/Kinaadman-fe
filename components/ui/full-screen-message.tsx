...
export function FullScreenMessage({
  ...
  return (
    <main className="archive-grid flex min-h-screen items-center justify-center px-4 py-16">
      <div className="paper-panel max-w-2xl space-y-6 px-8 py-12 text-center sm:px-12">
        <p className="muted-label">{eyebrow}</p>
        <div className="space-y-3">
          <h1 className="text-[clamp(2.2rem,4vw,3.75rem)] leading-[0.96] font-medium tracking-[-0.03em]">
            {title}
          </h1>
