...
export const navigation: NavItem[] = [
  {
    ...
    roles: ["STUDENT", "ADVISER", "LIBRARIAN", "TENANT_ADMIN", "SUPER_ADMIN"],
  },
  {
    href: "/profile",
    label: "Profile",
  ...
  },
  {
    ...
    roles: ["LIBRARIAN", "TENANT_ADMIN", "SUPER_ADMIN"],
  },
  {
    href: "/analytics",
    label: "Analytics",
    section: "Insights",
    description: "Review archive trends, publishing flow, and repository activity.",
